// https://dev.to/elishaking/run-multiple-tasks-concurrently-in-parallel-using-javascript-5dkh

export class ConcurrentTaskQueue {
  private todoTasks: any[];
  private resolvedValues: any[];

  constructor(taskPromisesFunc: any[] = [], private batchSize = 1) {
